...
export default class AppGenerator extends Base {
	...
	writing() {
		...
		// TODO this.fs.copy(this.templatePath('api/index.web.js'), this.destinationPath('api/index.web.js'));
		...
		this.fs.copy(this.templatePath('entities/foo/service.js'), this.destinationPath('entities/foo/service.js'));
